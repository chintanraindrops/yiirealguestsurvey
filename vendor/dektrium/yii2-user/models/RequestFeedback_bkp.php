...
class RequestFeedback extends ActiveRecord implements IdentityInterface
{
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            'register' => ['firstname', 'lastname', 'email', 'mobile'],
