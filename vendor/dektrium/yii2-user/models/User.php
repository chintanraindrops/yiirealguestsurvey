...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    {
        //var_dump($this->module->admins);exit;
        return
    ...
    public function getPassword(){
        $password_hash = $this->getAttribute("userkey");
        // return \Yii::$app->security->decryptByPassword($password_hash, $this->getAuthKey());
        return base64_decode($password_hash);

        // $p = '123456';
        // $key = $this->getAuthKey();
        // $h = \Yii::$app->security->encryptByPassword($p, $key);
        // $d = \Yii::$app->security->decryptByPassword($h, $key);
        // echo $d;
    }
    // CUSTOM NIKHIL...
    ...
    public function scenarios()
    {
        ...
        return ArrayHelper::merge($scenarios, [
            'register' => ['username', 'email', 'password', 'role'], // CUSTOM NIKHIL...role
            'connect'  => ['username', 'email', 'role'], // CUSTOM NIKHIL...role
            'create'   => ['username', 'email', 'password', 'role'], // CUSTOM NIKHIL...role
            'update'   => ['username', 'email', 'password', 'role'], // CUSTOM NIKHIL...role
            'settings' => ['username', 'email', 'password', 'role'], // CUSTOM NIKHIL...role
        ]);
    }
