...
class Finder extends Object
{
    ...
    /** @param ActiveQuery $locationQuery */
    public function setLocationQuery(ActiveQuery $locationQuery)
    {
     ...
     * @param int $id
     *
     * @return null|models\BusinessLocation
     */
    public function findLocationById($id)
    {
        return $this->findLocation(['id' => $id])->one();
    }
     ...
     * @return \yii\db\ActiveQuery
     */
    public function findLocation($condition)
    {
        return $this->locationQuery->where($condition);
    }
}
