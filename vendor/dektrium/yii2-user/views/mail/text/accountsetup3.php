...
<?= Yii::t('user', 'Locations') ?>:

<?php foreach ($locations as $key => $value) { ?>
	<?= Yii::t('user', 'Location') ?> - <?= $key ?>
	<?= Yii::t('user', 'Business Name') ?>: <?= $value['business_name'] ?>	
	<?= Yii::t('user', 'Address') ?>: <?= $value['address'] ?>	
	<?= Yii::t('user', 'City') ?>: <?= $value['city'] ?>	
	<?= Yii::t('user', 'State') ?>: <?= $value['state'] ?>	
	<?= Yii::t('user', 'Zip') ?>: <?= $value['zip'] ?>	
	<?= Yii::t('user', 'Phone') ?>: <?= $value['phone'] ?>
<?php } ?>