...
<div class="feedback-detail row">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<!-- <a href="index.php?r=user/clientDashboard/feedbacks" class="btn btn-default">Back</a> -->
			<a href="<?= Url::to(['/user/clientDashboard/feedbacks']) ?>" class="btn btn-default">Back</a>
		</div>
	</div>
</div>