...
class SettingsController extends Controller
{
    ...
    public function actionProfile()
    {
        ...
        // //if(!empty($model->logo)) { var_dump($model->logo);exit; }
        ...
        // //$model->load($_FILES);
        // // if($uploaded_file){
        //     $model->setAttribute('logo', $model->logo->name);
        // // }
        // // var_dump($model);
        // // exit;
        // echo "<pre>";
        ...
        // print_r($model); exit;
            ...
            $uploaded_file = $model->upload();
            if($uploaded_file){
                $model->setAttribute('logo', $uploaded_file);
            }
        if ($model->load(\Yii::$app->request->post()) && $model->save()) {
            ...
            if ($uploaded_file) {
                // $model->save();
                \Yii::$app->getSession()->setFlash('success', \Yii::t('user', 'Your profile and Company Logo has been updated'));
            } else {
