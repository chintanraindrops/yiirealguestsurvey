...
class ClientDashboardController extends Controller
{
		...
		return [
			'access' => [
				...
				'rules' => [
					...
					['allow' => true, 'actions' => ['dashboard', 'finalsetup', 'requestfeedback', 'account', 'uploadcsv', 'addstaff', 'addenduser', 'requestcontact', 'requestcontact2', 'profilesetup', 'location', 'requestcontact3', 'feedbacks', 'feedback', 'managestaff', 'editstaff', 'updatestaff', 'deletestaff', 'confirmstaff', 'blockstaff', 'unblockstaff'], 'roles' => ['?', '@']],
				],
			],
		];
	}
	...
	public function actionFinalsetup(){
		...
		$emailTemplate->title = $emailTemplateForm->title;
		$emailTemplate->template = $emailTemplateForm->template;
		$emailTemplate->template_id = $post['template_id'];
